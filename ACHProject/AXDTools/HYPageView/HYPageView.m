...
//            backView.barStyle   = UIBarStyleDefault;
            UIView *backView = [[UIView alloc] initWithFrame:_topTabView.bounds];
    ...
    if ([keyPath isEqualToString:@"currentPage"]) {
        ...
        for (NSInteger i=0; i<_viewControllers.count; i++) {
            if (page == i) {
                ...
                CGRect frame = CGRectMake(_selfFrame.size.width * i, offset, _selfFrame.size.width, _scrollView.bounds.size.height - offset - 50);
